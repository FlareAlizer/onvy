  ...
  return (
    <>
      ...
      <div className="mb-8 space-y-3">
        ...
        <Block icon={EyeOff} title="Голос не сохраняется">
          <p className="text-[13.5px] leading-relaxed text-slate-600">
            Onvy записывает только текст того, что было сказано — не звук. Никого не узнают по голосу:
            продукт не сравнивает голоса и не строит на них никаких профилей.
          </p>
        </Block>
      </div>
