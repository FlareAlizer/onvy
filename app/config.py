...
class Settings(BaseSettings):
    ...
    # Сырое аудио мы не храним вообще: в базу едут только текст реплики и
    # метрики стадий. Настройки срока хранения здесь намеренно нет — она
    # создавала бы впечатление политики хранения там, где хранения нет.
